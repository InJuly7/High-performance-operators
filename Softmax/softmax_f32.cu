...
template <unsigned int NUM_THREADS>
__global__ void softmax_f32_kernel(float* mat_A, float* mat_B, int N) {
...
#define LAUNCH_SOFTMAX_F32(H) \
    softmax_f32_kernel<(H)><<<grid, block>>>(reinterpret_cast<float*>(A.data_ptr()), reinterpret_cast<float*>(B.data_ptr()), (H));

#define DISPATCH_SOFTMAX_F32(S, H)                                      \
    dim3 block((H));                                                    \
    dim3 grid((S));                                                     \
    switch ((H)) {                                                      \
        case 32:                                                        \
            LAUNCH_SOFTMAX_F32(32) break;                               \
        case 64:                                                        \
            LAUNCH_SOFTMAX_F32(64) break;                               \
        case 128:                                                       \
            LAUNCH_SOFTMAX_F32(128) break;                              \
        case 256:                                                       \
            LAUNCH_SOFTMAX_F32(256) break;                              \
        case 512:                                                       \
            LAUNCH_SOFTMAX_F32(512) break;                              \
        case 1024:                                                      \
            LAUNCH_SOFTMAX_F32(1024) break;                             \
        default:                                                        \
